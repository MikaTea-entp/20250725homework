...
session_start();
// すでにログイン済みならネタ帳へ
// テーブル作成時にidを忘れていたので、代わりにemailでログイン管理
...
<body>
    ...
    <form action="https://mikatea.sakura.ne.jp/SCAMPER_Novelist/bookofdays/login_act.php" method="POST">
        <label>メールアドレス: <input type="email" name="email" required></label><br>
        <label>パスワード: <input type="password" name="password" required></label><br>
        <button type="submit">ログイン</button>
    </form>

    <p><a href="../user_register/register.php">新規登録はこちら</a></p>
</body>
</html>
